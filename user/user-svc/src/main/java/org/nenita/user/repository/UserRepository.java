...
/**
 * All neo4j queries related to the user and its immediate relationships. Note
 * that appropriate indexes should have been generated by a separate process to
...
public interface UserRepository extends GraphRepository<User> {
	...
	/**
	 * Find user by firstname. Assumes uniqueness by firstname
	 * 
	 * @param firstname
	 * @return
	 */
	...
	/**
	 * Find user by firstname and lastname. Assumes uniqueness by firstname and lastname
	 * 
	 * @param firstname
	 * @param lastname
	 * @return
